 ...
 */
public class ForceNetForObjectArray extends ArrayGetStrategy<Map<String, Object>> {

    private MemoryStorage mMemoryDataPool;
    private NetClient mNetClient;

    public ForceNetForObjectArray(String dataType, String url, String requestTag, ResponseListener<List<Map<String, Object>>> callback) {
    ...
    public void fetchData() {
        ...
        if (datas != null && datas.size() > 0) {
            ...
            notifyCallerSuccess(DataFrom.CACHE, datas, false);
