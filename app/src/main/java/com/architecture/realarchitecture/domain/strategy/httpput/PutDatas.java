package com.architecture.realarchitecture.domain.strategy.httpput;
 ...
 */
public class PutDatas<K, V> implements NetClientCallback<V> {
    ...
    public PutDatas(String dataType, String url, String requestTag, ResponseListener<V> callback, K data) {
    ...
    public void putData() {
        ...
        mNetClient.performHttpPut(mUrl, mRequestTag, new NetClientCallback<V>() {
            @Override
